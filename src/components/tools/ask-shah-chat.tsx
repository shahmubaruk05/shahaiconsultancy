...
const GREETING_MESSAGE: Message = { role: 'assistant', content: 'Hello! I am Shah, your AI startup advisor. How can I help you today?' };
...
export function AskShahChat({ initialConversationId }: { initialConversationId: string | null }) {
  ...
  useEffect(() => {
    if (firestoreMessages) {
        ...
        setMessages([GREETING_MESSAGE, ...newMessages]);
    } else if (!messagesLoading) {
        setMessages([GREETING_MESSAGE]);
    }
  }, [firestoreMessages, messagesLoading]);
